...
function Index() {
  ...
  return <main className="overflow-hidden bg-background text-foreground">
      ...
      <div className="section-shell relative z-10 flex min-h-[94svh] flex-col justify-between py-6 sm:py-10">
        ...
        <div className="grid items-center gap-10 py-12 lg:grid-cols-[1.15fr_.85fr]">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-xs text-ivory/72">Pré-lançamento · Lançamento oficial em 1º de novembro · Tiragem limitada</p>
          </div>
    ...
    <section className="bg-ivory py-24 sm:py-32"><div className="section-shell mx-auto max-w-3xl text-center"><Flame className="mx-auto size-8 text-gold" strokeWidth={1.3}/><h2 className="mt-7 text-balance text-4xl text-navy sm:text-5xl">Às vésperas do Dia de Finados, uma palavra de esperança.</h2><p className="mt-7 leading-8 text-charcoal/80">1º de novembro marca o lançamento oficial de um livro que nasceu para falar sobre aquilo que muitas famílias carregam no coração: a saudade de quem partiu. O Dia de Finados nos convida à memória, à oração e à esperança cristã.</p><p className="mt-5 leading-8 text-charcoal/80">Não para falar apenas sobre a morte. Mas para lembrar que, para quem crê, a história não termina na ausência.</p></div></section>
    ...
    <section className="bg-ivory py-24 sm:py-32"><div className="section-shell mx-auto max-w-2xl"><div className="text-center"><Eyebrow>Perguntas frequentes</Eyebrow><h2 className="text-4xl text-navy sm:text-5xl">Ainda com alguma dúvida?</h2></div><div className="mt-14 divide-y divide-gold/25 border-y border-gold/40">
      <details className="group py-6"><summary className="cursor-pointer list-none text-lg text-navy marker:content-none">O livro é físico ou digital?</summary><p className="mt-3 leading-7 text-charcoal/80">[Preencher: formato de entrega — impresso, digital ou ambos.]</p></details>
      <details className="group py-6"><summary className="cursor-pointer list-none text-lg text-navy marker:content-none">Quando recebo meu exemplar do pré-lançamento?</summary><p className="mt-3 leading-7 text-charcoal/80">[Preencher: prazo estimado de envio após o pré-lançamento e após o lançamento oficial em 1º de novembro.]</p></details>
    ...
    <footer className="bg-navy py-14 text-center text-ivory"><div className="section-shell"><Divider/><p className="mt-7 font-display text-2xl">Coleção Âncora</p><p className="mt-2 text-xs uppercase tracking-[0.18em] text-gold">Palavras de esperança para os caminhos da vida</p><p className="mt-8 text-sm text-ivory/65">Livro I · Quando a Saudade Permanece · Pe. Wesley Xavier Ramos</p>{/* TODO: incluir nome da editora/entidade responsável e um contato (WhatsApp/e-mail) reais. */}<p className="mt-3 text-xs text-ivory/50">© 2026. Todos os direitos reservados.</p></div></footer>
