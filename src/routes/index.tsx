...
function Index() {
  ...
  return <main className="overflow-hidden bg-background text-foreground">
    ...
    <section className="bg-ivory py-24 sm:py-32"><div className="section-shell mx-auto max-w-2xl"><div className="text-center"><Eyebrow>Perguntas frequentes</Eyebrow><h2 className="text-4xl text-navy sm:text-5xl">Ainda com alguma dúvida?</h2></div><div className="mt-14 divide-y divide-gold/25 border-y border-gold/40">
      ...
      <details className="group py-6"><summary className="cursor-pointer list-none text-lg text-navy marker:content-none">Quando e como recebo meu exemplar?</summary><p className="mt-3 leading-7 text-charcoal/80">Há duas formas de participar. Você pode retirar o livro pessoalmente no dia 1º de novembro, no lançamento oficial, e participar da noite de autógrafos com o Pe. Wesley. Ou, se preferir, pode recebê-lo pelo Correio no conforto da sua casa — a entrega acontece em até 10 dias úteis após o lançamento oficial de 1º de novembro.</p></details>
