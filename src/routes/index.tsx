...
function Index() {
  ...
  return <main className="overflow-hidden bg-background text-foreground">
    ...
    <section className="bg-background py-24 sm:py-32"><div className="section-shell"><div className="mx-auto max-w-2xl text-center"><Eyebrow>O que você vai encontrar no livro</Eyebrow><h2 className="text-4xl text-navy sm:text-5xl">Uma caminhada da dor à esperança.</h2></div><div className="relative mt-16 grid gap-0 border-y border-gold/40 md:grid-cols-5">{journey.map(([n,t,d])=><article key={n} className="border-b border-gold/25 px-6 py-9 last:border-0 md:border-r md:border-b-0"><span className="font-display text-3xl text-gold/60">{n}</span><h3 className="mt-4 text-2xl text-navy">{t}</h3><p className="mt-3 text-sm leading-6 text-muted-foreground">{d}</p></article>)}</div></div></section>
