  ...
  return <main className="overflow-hidden bg-background text-foreground">
      ...
      <div className="section-shell relative z-10 flex min-h-[94svh] flex-col justify-between py-6 sm:py-10">
        ...
        <div className="grid items-center gap-10 py-12">
          <div className="max-w-2xl">
            ...
            <div className="my-8 w-[min(78vw,380px)]"><img src={bookCover} alt="Capa do livro Quando a Saudade Permanece" width={853} height={1280} className="w-full object-contain drop-shadow-2xl"/></div>
    ...
    <section id="pre-lancamento" className="bg-navy py-24 text-ivory sm:py-32"><div className="section-shell">
      <div className="grid items-start gap-14 border-b border-gold/40 pb-14 lg:grid-cols-[1.2fr_.8fr]">
        ...
        <div className="border border-gold/50 p-8 text-center"><p className="text-xs uppercase tracking-[0.2em] text-gold">Pré-lançamento</p><p className="my-5 font-display text-6xl text-ivory">02<span className="block text-2xl">de novembro de 2026</span></p><div className="gold-rule"/><p className="mt-5 text-xs uppercase tracking-[0.18em] text-ivory/72">Lançamento oficial · Dia de Finados</p><p className="mt-5 font-display text-3xl text-gold">{price}</p><p className="mt-1 text-xs uppercase tracking-[0.16em] text-ivory/72">{priceNote}</p></div>
      </div>
